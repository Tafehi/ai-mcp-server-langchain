...
# def main():
#     asyncio.run(client.agents("llama3.2:latest", "ollama", "what is the current weather in Oslo?"))
...
log_placeholder = "AWS log output will appear here..." if provider == "aws" else "Ollama log output will appear here..."
